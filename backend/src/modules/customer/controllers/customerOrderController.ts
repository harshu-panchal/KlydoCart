...
export const createOrder = async (req: Request, res: Response) => {
    ...
    try {
        ...
        try {
            ...
            console.error("Error notifying delivery boys/sellers:", notificationError);
        }
...
export const getOrderById = async (req: Request, res: Response) => {
    try {
        ...
        // Show delivery OTP only if the delivery partner has requested it (order.deliveryOtp is set)
        const deliveryOtp = order.deliveryOtp || undefined;
