              ...
              >
                ...
                <div className="border-t border-neutral-200 pt-3 mt-3">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      <p className="text-neutral-500 text-[10px] uppercase font-bold tracking-wider">Value</p>
                    ...
                    <div className="text-right bg-orange-50 px-3 py-1 rounded-lg border border-orange-100">
                      <p className="text-orange-500 text-[8px] uppercase font-bold tracking-wider">Earning</p>
